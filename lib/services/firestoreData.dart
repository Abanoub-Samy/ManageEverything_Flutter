...
class FireStoreData {
  ...
  Future createNewManager(String id, String name, String dateBirth,
    ...
    return await _churchCollection
        .document()
  ...
  List<ChurchModel> _churchListSnapShot(QuerySnapshot snapshot) {
    return snapshot.documents.map((doc) {
      return ChurchModel(churchName: doc.data['churchName'] ?? '');
    }).toList();
  }

  Stream<List<ChurchModel>> get churchData {
    return _churchCollection.snapshots().map(_churchListSnapShot);
  }
